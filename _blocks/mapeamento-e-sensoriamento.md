...
* **Sensoriamento remoto do seringal entre as árvores, sob copas:** Utilizando um VANT equipado com um sistema de telemetria de alta precisão e outro de reconhecimento de obstáculos, interligado aos sensores de ambiente remoto de alta performance, conseguimos planejar vôos rasantes entre as árvores e sob as copas, gerando com isso um mapeamento e sensoriamento por completo do seringal, entregando ao heveicultor relatórios ainda mais completos, incluindo também análise por espectros dos troncos, dos painéis abertos, da casca regenerada, do consumo de casca, etc. e podendo inclusive gerar outros produtos, como um mapa virtual 360º e interativo do seringal (_como o street view do google_) possibilitando que o técnico agrônomo possa explorar todo o seringal remotamente por exemplo, ou então para gerar um mapa virtual específico para utilizar no módulo "piloto-automático" em desenvolvimento com o conjunto de implementos Smartex linha MOBILE.