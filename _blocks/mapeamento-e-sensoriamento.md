...
##### Porém na heveicultura, nem toda informação útil está sobre as copas das seringueiras e, como as copas são bloqueadores naturais de sinais de antena e satélite, precisamos equipar um VANT com um sistema de telemetria de alta precisão, além de um sistema de reconhecimento de ambiente e obstáculos, interligados a sensores remotos de alta performance e tudo gerenciado por um microcomputador embarcado no veículo, para somente assim conseguimos planejar vôos rasantes, entre as árvores e sob as copas para gerar um mapeamento e sensoriamento totalmente preciso do seringal, entregando ao heveicultor relatórios ainda mais completos, adicionando análise por espectros dos troncos, painéis abertos, casca consumida, casca regenerada, solo, etc.
