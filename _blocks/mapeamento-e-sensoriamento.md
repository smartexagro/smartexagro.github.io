...
* **Mapeamento aéreo fotogramétrico de precisão:** Através do mapeamento aéreo utilizando um sistema de telemetria de alta precisão, é possível gerar um mapa virtual da propriedade rural, para futuramente implementar no "módulo piloto-automático" utilizado em implementos Smartex da linha MOBILE, necessário para precisão nos sistema de orientação, já que existe grande dificuldade de sinal de satélite e antenas para comunicação de GPS debaixo das copas das árvores.